...
function MesAnnonces(prop) {
    ...
    return (
        <div id="div_global_annonces" className={"annonces_div_general"}>
            <Produit_mon_annonce typeProfil={"mesAnnonces"} titre={prop.titre} lVente={prop.lVente} lAchat={prop.lAchat} acheteur={prop.acheteur} imageURL={prop.imageURL} transporteur={prop.transporteur} />
            <Detail_prix Prix1={prop.Prix1} PrixVol={prop.PrixVol} Prix3={prop.Prix3} PrixProduit={prop.PrixProduit} coutTot={prop.coutTot} devise={prop.devise}/>
