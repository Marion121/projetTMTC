    ...
    function payement() {
       ...
       /* Swal.fire = function () {
            ...
            if (arguments[0].showCloseButton) {
                Swal.closeButton = document.getElementById('bouton_payer');
                Swal.CloseButton.onclick = function () {
                    swal.close();
                };
                Swal.closeButton.textContent = 'Payer 1 €';
                Swal.modal = document.querySelector('.swal-modal');
                Swal.modal.appendChild(closeButton);
            }
        }*/
...
/*    { open &&
            <div class={"modulegolbal"} id="myModal">
                <div className={"modulegolbal_content"}>
                    <span className="close">&times;</span>
                    <div class="div_entete"><b>Payement de votre annonce</b>
                    </div>
                    <div class="conteur_general_pop_up">
                        <b id="text_detail">Détail des modalité de payement</b>
                        <div id="div_1" class="conteur_pop_up">
