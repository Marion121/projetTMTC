    ...
    return (
        <div >
            ...
            <div className="container_mes_achats">
                ...
                {mesAnnonces.map(dataprop => <Mon_annonce titre={dataprop.titre}  lVente={dataprop.ville}  PrixProduit={dataprop.prix} devise={dataprop.devise} imageURL={dataprop.image} etat="manqueVoyageur" ></Mon_annonce>)}
            </div>
        </div>
    );
}
